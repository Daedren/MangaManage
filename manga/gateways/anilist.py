...
class TrackerGatewayInterface:
  def getProgressFor(self, mediaId): pass
  def searchMediaBy(self, title): pass
  def getAllEntries(self): pass
...
class AnilistGateway(TrackerGatewayInterface):
  ...
  def searchMediaBy(self, title):
    ...
    Media(search: $searchId) {
      ...
      titles = [titleObj["romaji"], titleObj["english"],
                titleObj["native"], titleObj["userPreferred"]]
