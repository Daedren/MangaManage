    ...
    def execute(self):
        ...
        for row in rows:
            ...
            if anilistSeries is None:
                ...
                continue
            lastReadChapter = series[dbAnilistId]["progress"] # Progress at anilist of series.
            lastReleasedChapter = series[dbAnilistId]["media"]["chapters"]
            if lastReleasedChapter == lastReadChapter: # Chapter is null if series is still releasing
                lastReadChapter += 30
            ...
            for chap in chaptersToDelete:
                ...
                print("could be deleted "+dbSeries +
                    " - ("+str(chapterToDelete)+" <= "+str(lastReadChapter)+")")
